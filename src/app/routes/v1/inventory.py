...
@router.get("/")
async def get_all_inventory(all_inventory_use_case: Annotated[GetAllInventoryUseCase, Depends(get_all_inventory_use_case)]) -> GetAllInventoryResponse:
...
@router.get("/search")
async def search_inventory(q: str, search_inventory_use_case: Annotated[SearchInventoryUseCase, Depends(get_search_inventory_use_case)]) -> SearchInventoryResponse:
