...
from use_cases.search_inventory.schema import SearchInventoryResponse
from use_cases.get_all_inventory.interactor import GetAllInventoryUseCase
from use_cases.get_all_inventory.schema import GetAllInventoryResponse
...
from app.dependencies import (
    get_search_inventory_use_case,
    get_all_inventory_use_case,
    get_update_inventory_use_case,
)
...
async def get_all_inventory(
    all_inventory_use_case: Annotated[
        GetAllInventoryUseCase, Depends(get_all_inventory_use_case)
    ]
...
async def update_inventory(
    ...
    update_inventory_use_case: Annotated[
        UpdateInventoryUseCase, Depends(get_update_inventory_use_case)
    ],
):
...
async def search_inventory(
    q: str,
    search_inventory_use_case: Annotated[
        SearchInventoryUseCase, Depends(get_search_inventory_use_case)
    ],
